            ...
            <div className='subscription-form'>
                ...
                <form onSubmit={this.submitForm.bind(this)} style={formStyle}>
                    ...
                    <div className='subscription-form-field-group'>
                        ...
                        <input type='text' id='firstNameField' onChange={this.onFirstNameChanged.bind(this)}
                               ref='firstNameField' value={this.state.firstName}/>
                    </div>

                    <div className='subscription-form-field-group'>
                        <label htmlFor='lastNameField'>Last name</label>
                        <input type='text' id='lastNameField' onChange={this.onLastNameChanged.bind(this)}
                               ref='lastNameField' value={this.state.lastName}/>
                    </div>
