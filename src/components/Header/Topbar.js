...
class Topbar extends Component {
    ...
    render() {
        return (
            <React.Fragment>
                <div className="navbar navbar-expand shadow flex-column flex-md-row navbar-custom">
                    <Container fluid>
                        { /* logo */}
                        <Link to="/" className="navbar-brand mr-0 mr-md-2 logo">
              <span className="logo-lg">
                <img src={logo} alt="" height="24"/>
                <span className="d-inline h5 ml-2 text-logo">Artmoksha</span>
              </span>
                ...
                <img src={logo} alt="" height="24"/>
                        ...
                        <ul className="navbar-nav flex-row ml-auto d-flex list-unstyled topnav-menu float-right mb-0">
                            ...
                            <ProfileDropdown profilePic={profilePic} menuItems={ProfileMenus} username={'artmoksha'}
