            ...
            <CardBody className="pt-2 pb-3">
                ...
                <PerfectScrollbar style={{ maxHeight: '376px' }}>
                    <TaskList>
                        ...
                        <TaskItem title='iOS MokshaApp home page' due_date="23 Aug, 2019" className="mt-2" />
                        <TaskItem title='Write a release note for artmoksha' due_date="24 Aug, 2019" className="mt-2" />
                        <TaskItem title='Invite us to a project artmoksha admin' due_date="22 Aug, 2019" className="mt-2" />
