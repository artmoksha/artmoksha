                ...
                <Row>
                    <Col>
                        <div className="text-center mt-3">
                            ...
                            <h5 className="mt-2 mb-0">Null Adderess</h5>
                            <h6 className="text-muted font-weight-normal mt-1 mb-4">0x4E3f2D3a73ED1AFe163D414EC632445e315A11C1</h6>
                        </div>

                        <div className="mt-5 pt-2 border-top">
                            <h4 className="mb-3 font-size-15">About</h4>
                            <p className="text-muted mb-4">Hi I'm ArtMoksha. I am user experience and user
